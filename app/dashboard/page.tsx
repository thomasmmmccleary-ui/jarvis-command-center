...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-surface/20 px-6 py-2 flex items-center justify-between">
        <a
          href="/"
          className="text-xs text-cyan-500 hover:text-cyan-400 flex items-center gap-2 transition-colors"
        >
          ← 🏢 Back to Office View
        </a>
        <span className="text-xs text-gray-600 font-mono">Classic Kanban Dashboard</span>
      </div>
